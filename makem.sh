...
function elisp-buttercup-file {
    ...
    then
        elisp_buttercup_file=$(gmktemp --tmpdir --suffix=".el" "makem-elisp-buttercup-file-XXX")
...
function elisp-elint-file {
    if ! [[ $elisp_elint_file ]]
    then
        elisp_elint_file=$(gmktemp --tmpdir --suffix=".el" "makem-elisp-elint-file-XXX")
...
function elisp-checkdoc-file {
    ...
    then
        elisp_checkdoc_file=$(gmktemp --tmpdir --suffix=".el"  "makem-elisp-checkdoc-file-XXX")
...
function elisp-byte-compile-file {
    ...
    then
        elisp_byte_compile_file=$(gmktemp --tmpdir --suffix=".el" "makem-elisp-byte-compile-file-XXX")
...
function elisp-check-declare-file {
    ...
    then
        elisp_check_declare_file=$(gmktemp --tmpdir --suffix=".el" "makem-elisp-check-declare-file-XXX")
...
function elisp-lint-indent-file {
    ...
    then
        elisp_lint_indent_file=$(gmktemp --tmpdir --suffix=".el" "makem-elisp-lint-indent-file-XXX")
...
function elisp-package-initialize-file {
    ...
    then
        elisp_package_initialize_file=$(gmktemp --tmpdir --suffix=".el" "makem-elisp-package-initialize-file-XXX")
...
function run_emacs {
    ...
    # Set output file.
    output_file=$(gmktemp --tmpdir --suffix=".txt" "makem-emacs-output-XXX") || die "Unable to make output file."
...
function sandbox {
    ...
    then
        ...
        local sandbox_dir=$(gmktemp --tmpdir -d "makem-emacs-sandbox-dir-XXX") || die "Unable to make sandbox dir."
